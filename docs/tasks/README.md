...
| Task | 목표 | PR | 상태 |
| --- | --- | --- | --- |
| [001 · Terraform 기반과 PR 검증](001-terraform-foundation.md) | S3 state·OIDC·Budget·환경별 plan 기반 | [#1](https://github.com/ban-dal/aws-ecs-fullstack-app/pull/1) | 진행 중: PR 열림 (2026-09-23 확인) |
