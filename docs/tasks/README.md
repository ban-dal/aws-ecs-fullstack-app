...
| [003 · 서비스 기반 네트워크와 ECR](003-service-foundation.md) | 환경별 VPC·서브넷·보안 그룹·ECR 코드와 PR plan | [#3](https://github.com/ban-dal/aws-ecs-fullstack-app/pull/3) | 진행 중: PR plan 검증 대기 |
